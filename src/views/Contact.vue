<template>
  <div>
    ...
    <section class="text-center py-8">
      <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-2">Contact Us</h1>
    </section>

    <!-- Contact Info (3 kotak: email, phone, location) -->
    ...
    <!-- FOOTER MANUAL -->
    <section class="bg-pink-50 border-t py-16 px-4 mt-12">
